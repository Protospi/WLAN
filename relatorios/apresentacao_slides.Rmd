...
![](../imagens/espacos_discretos_irregulares.png){width=70%, height=70%}
...
![](https://raw.githubusercontent.com/Protospi/WLAN/main/imagens/solucao_9x9.png){width=70%, height=70%}
...
![](../imagens/mapa_superficie_pas.png){width=70%, height=70%}
...
![](../imagens/mapa_superficie_tempos_edit.png){width=70%, height=70%}
...
![](../imagens/solucao_110x110.png){width=70%, height=70%}
...
![](../imagens/resumo_robos.png){ width=90% }
...
![](../imagens/criterio_Mbps.png){ width=90% }
...
![](../imagens/criterio_cobertura.png){ width=90% }
...
![](../imagens/criterio_pas.png){ width=90% }
...
![](../imagens/criterio_geral.png){ width=90% }
...
![](../imagens/resultados_AHP.png){ width=90% }
