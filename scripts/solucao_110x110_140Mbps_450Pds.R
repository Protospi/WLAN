...
# Solução com espaço discreto M de 110 x 110 90 % = 450 Pd's
...
p <- p + geom_point(resultados,
  ...
  ggtitle("Posição Ótima para os Pontos de Acesso",
          subtitle = "Mínimo global de 9 Pa's no espaço discreto de 110 x 110 cobertura de 450 Pd's (90%), máximo 140 Mbps.")+
